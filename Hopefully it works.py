...
dataset_root = (r"C:\Users\DELL\Desktop\Project Code\NSL-KDD")
...
with open(r"C:\Users\DELL\Desktop\Project Code\NSL-KDD\training_attack_types.txt", 'r') as f:
...
#confusion_matrix_from_KNN_df = pd.DataFrame(index = ['benign', 'dos', 'probe', 'r2l', 'u2r'], columns = ['benign', 'dos', 'probe', 'r2l', 'u2r'])
#plt.figure(figsize=(15,10))
#plt.title('Confusion Matrix for KNN Classifier on KDD-NSL Dataset')
#plt.ylabel('Actual Values')
#plt.xlabel('Predicted Values')
#sn.heatmap(confusion_matrix_from_KNN_df, annot=True) # font size
#plt.show()
...
accuracy_bars = round(accuracy_AdaBoost * 100, 2), round(accuracy_KNN * 100, 2), round(accuracy_decision_tree * 100, 2)

precision_bars = round(precision_AdaBoost * 100, 2), round(precision_KNN * 100, 2), round(precision_decision_tree * 100, 2)

recall_bars = round(recall_AdaBoost * 100, 2), round(recall_KNN * 100, 2), round(recall_decision_tree * 100, 2)

f1_score_bars =round(f1_score_AdaBoost * 100, 2), round(f1_score_KNN * 100, 2), round(f1_score_decision_tree * 100, 2)

overall_false_positive_rate_bars = round(overall_false_positive_rate_AdaBoost * 100, 2), round(overall_false_positive_rate_KNN * 100, 2), round(overall_false_positive_rate_decision_tree * 100, 2)
...
plt.xticks([algorithms + bar_size for algorithms in range(len(accuracy_bars))], ['AdaBoost', 'K Nearest Neighbour', 'Decision Tree'])
